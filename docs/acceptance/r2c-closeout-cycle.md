...
| UX-08C | Keyboard menus and task Retry/Cancel; correct focus return, immediate feedback and one committed action | Shared menu/task surfaces; `ame_menu_test.dart`, `library_retained_scan_interaction_test.dart`; [actual menu Escape and viewer keyboard verified](r2c-process-lifecycle.md#recovered-real-input-pair); task Retry/Cancel and complete focus assertions remain open |
